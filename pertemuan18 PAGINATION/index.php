...
<body>
    ...
    <div class="table-responsive">
      <table class="text-center table" border="0" cellpadding="10" cellspacing="0">
        ...
        <tr>
          ...
          <td>
            <div class="dropdown">
              <button class="btn dropdown-toggle aksi" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                aria-expanded="false">
                Action
              </button>
  ...
  <footer class="text-center text-dark mt-5">
    <p>Created with <i class="bi bi-suit-heart-fill text-danger"></i> by <a href="https://www.instagram.com/dresevtian/"
        class="text-dark fw-bold">Andre
        Sevtian</a></p>
  </footer>
